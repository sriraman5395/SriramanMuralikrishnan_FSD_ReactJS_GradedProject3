// src/components/MovieInTheatre.js
...
function MovieInTheatre({ onAddToFavorites, favorites }) {
  ...
  return (
    <div className="movie-cards">
      {moviesData["movies-in-theaters"].map((movie, index) => (
